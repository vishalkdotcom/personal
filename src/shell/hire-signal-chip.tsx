      ...
      <div class="absolute right-3.5 bottom-4 z-[22] flex flex-col items-end gap-2">
        <Show when={expanded()}>
          <div class="w-[220px] rounded-[14px] border border-border bg-bg-deep p-3 shadow-[0_12px_32px_rgba(0,0,0,0.4)]">
            <h2 class="m-0 mb-1 flex items-center gap-1.5 text-xs font-[650] text-ok">
        ...
        <button
          type="button"
          class="flex items-center gap-2 rounded-full border border-border bg-bg-deep px-3 py-2.5 text-xs font-[650] text-ok shadow-[0_8px_24px_rgba(0,0,0,0.35)]"

...
const MODE_META: PageMeta[] = [
  ...
  page(
    "/privacy",
    "Privacy",
    `Privacy practices for ${ABOUT_NAME}'s personal portfolio at vishalk.com — contact form, analytics, and local theme storage.`,
  ),
 ...
 * Unknown paths keep path + canonical honest to the request URL (edge returns HTTP 404).
 */
